...
```{r}
plot(em1$emmeans)
p <- plot(em1$contrasts) #para la diferencia relevante
p + geom_vline(xintercept = 1, linetype = "solid", color = "red", size = 1)
```
...
```{r}
plot(b, pot, type = "l", ylab = "Potencia", xlab = "Número de Bloques")
abline(h = 1, lty = 2)
abline(v= 17, lty = 2)
```
